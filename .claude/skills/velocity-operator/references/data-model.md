...
- **What survives** — the row a contact already points at (`contacts.person_prospect_id`); if several or none qualify, the **lowest id**. Never `updatedAt`, which churns on every enrichment sweep.
