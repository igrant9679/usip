...
export default function Social() {
  ...
  return (
    <Shell title="Social Publishing">
      <PageHeader title="Social Publishing" description="Schedule, publish, and analyse social posts across LinkedIn, Twitter/X, Facebook, and Instagram. Use AI to generate post copy, optimise posting times, and track engagement metrics." pageKey="social"
