...
CREATE INDEX IF NOT EXISTS `ix_aav_campaign` ON `are_ab_variants` (`campaignId`);
CREATE INDEX IF NOT EXISTS `ix_arec_ws` ON `are_campaigns` (`workspaceId`);
CREATE INDEX IF NOT EXISTS `ix_arec_status` ON `are_campaigns` (`workspaceId`,`status`);
CREATE INDEX IF NOT EXISTS `ix_aeq_campaign` ON `are_execution_queue` (`campaignId`);
CREATE INDEX IF NOT EXISTS `ix_aeq_prospect` ON `are_execution_queue` (`prospectQueueId`);
CREATE INDEX IF NOT EXISTS `ix_aeq_scheduled` ON `are_execution_queue` (`workspaceId`,`status`,`scheduledAt`);
CREATE INDEX IF NOT EXISTS `ix_asj_ws` ON `are_scrape_jobs` (`workspaceId`);
CREATE INDEX IF NOT EXISTS `ix_asj_campaign` ON `are_scrape_jobs` (`campaignId`);
CREATE INDEX IF NOT EXISTS `ix_asl_prospect` ON `are_signal_log` (`prospectQueueId`);
CREATE INDEX IF NOT EXISTS `ix_asl_campaign` ON `are_signal_log` (`campaignId`);
CREATE INDEX IF NOT EXISTS `ix_asl_type` ON `are_signal_log` (`workspaceId`,`signalType`);
CREATE INDEX IF NOT EXISTS `ix_asupp_ws` ON `are_suppression_list` (`workspaceId`);
CREATE INDEX IF NOT EXISTS `ix_asupp_email` ON `are_suppression_list` (`workspaceId`,`email`);
CREATE INDEX IF NOT EXISTS `ix_icp_ws` ON `icp_profiles` (`workspaceId`);
CREATE INDEX IF NOT EXISTS `ix_icp_ws_ver` ON `icp_profiles` (`workspaceId`,`version`);
CREATE INDEX IF NOT EXISTS `ix_pi_prospect` ON `prospect_intelligence` (`prospectQueueId`);
CREATE INDEX IF NOT EXISTS `ix_pi_ws` ON `prospect_intelligence` (`workspaceId`);
CREATE INDEX IF NOT EXISTS `ix_pq_campaign` ON `prospect_queue` (`campaignId`);
CREATE INDEX IF NOT EXISTS `ix_pq_ws` ON `prospect_queue` (`workspaceId`);
CREATE INDEX IF NOT EXISTS `ix_pq_email` ON `prospect_queue` (`email`);
CREATE INDEX IF NOT EXISTS `ix_pq_status` ON `prospect_queue` (`campaignId`,`enrichmentStatus`);
