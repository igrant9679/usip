...
const TOURS: TourSeed[] = [
  {
    ...
    steps: [
      ...
      { title: "Your sidebar", bodyMarkdown: "Quick links up top (Home, AI Assistant), then your core sections: Prospect and enrich, Engage, Win deals, Automation and analytics, Inbound. Saved records and a More group below hold everything else.", targetDataTourId: "sidebar-nav", visualTreatment: "spotlight", advanceCondition: "next_button" },
