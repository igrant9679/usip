...
5. **Meeting Autopilot** proposes meetings with times and a drafted invite for prospects who look ready. In Approve you edit and approve each one before it sends; in Autonomous each new invite sends on its own.
...
export const TOURS: TourSeed[] = [
  ...
  },
  {
    ...
    roleTags: ["sdr"],
    steps: [
      { title: "Three ways a meeting appears", bodyMarkdown: "You book one manually, Meeting Autopilot proposes times (you approve them, or in Autonomous it sends them), or someone books themselves through your link or the website chat agent. They all land here.", routeTo: "/v2/meetings", targetDataTourId: "meetings-list", visualTreatment: "spotlight", advanceCondition: "next_button" },
