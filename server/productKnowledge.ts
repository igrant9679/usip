...
Prospect sources (WarmySender leads, QuickEnrich, Apollo): searched in the Settings checking order, stop at target, dedupe before spend, budget-ledgered; keys and each source's Enabled switch under Settings → Data sources.
