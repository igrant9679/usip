...
describe("companies.duplicates", () => {
  ...
  it("returns [] when no domain is shared (and never runs the count query)", async () => {
    const cap: { accountsWhere?: unknown; contactsWhere?: unknown } = {};
    h.db = makeDb(
      [
        { id: 1, key: "a.com", name: "A", domain: "a.com", createdAt: null },
        { id: 2, key: "b.com", name: "B", domain: "b.com", createdAt: null },
      ],
      [],
      cap,
    );
